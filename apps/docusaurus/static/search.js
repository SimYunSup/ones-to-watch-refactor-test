// Vanilla ESM munja search client, ported verbatim from
// apps/kudzu/public/search.js with only the BASE path constant (and the
// matching import specifier) swapped from /kudzu/ to /docusaurus/. Shipped
// as a plain static asset (docusaurus.config.js's default
// `staticDirectories: ["static"]` copies it into build/ unmodified) and
// loaded via a plain <script type="module"> tag on the home and archive
// route components — see plugins/newsletter.js's postBuild for how
// index.bin/munja/ land alongside it in build/.
//
...
import init, { search_json } from "/ones-to-watch-refactor-test/docusaurus/munja/munja.js";

const BASE = "/ones-to-watch-refactor-test/docusaurus";
