// Vanilla ESM munja search client, ported from apps/kudzu/public/search.js
// with only the BASE constant changed — this variant's public/search.js is
// not run through Next's compiler either (it is a plain <script type="module">
// tag, not an import inside a page/component), so the same reasoning applies:
// no vendored npm packages, no wasm imports resolved by a bundler. It ships
// as-is under public/ (Next copies public/ verbatim into out/) and is loaded
// via a plain <script type="module"> tag on the home and archive pages.
//
...
import init, { search_json } from "/ones-to-watch-refactor-test/next-pages/munja/munja.js";

const BASE = "/ones-to-watch-refactor-test/next-pages";
