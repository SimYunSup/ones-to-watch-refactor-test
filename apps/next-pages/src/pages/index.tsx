...
export const getStaticProps: GetStaticProps<{ cards: PostCardData[] }> = async () => {
...
export default function HomePage({ cards }: InferGetStaticPropsType<typeof getStaticProps>) {
  return (
    <>
      <Head>
        <title>Ones To Watch for FrontEnd</title>
        <meta name="description" content="매주 프론트엔드 소식을 정리해서 보내드립니다." />
      </Head>
      <Header />
      <main className="home">
