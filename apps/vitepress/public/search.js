...
// apps/kudzu/public/search.js with only the BASE constant and import
// specifier below repointed at this variant's own sub-path. VitePress's
// custom theme still renders the same `[data-munja]` markup
// (HomeView.vue / ArchiveView.vue), so the DOM contract this script expects
