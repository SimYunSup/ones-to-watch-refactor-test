...
// Hugo's static/ directory is copied verbatim to the site root (no
// templating), same as kudzu's public/ — so, like there, this file cannot
// use relURL and instead hardcodes the /hugo/ base path below.
//
...
import init, { search_json } from "/ones-to-watch-refactor-test/hugo/munja/munja.js";

const BASE = "/ones-to-watch-refactor-test/hugo";
